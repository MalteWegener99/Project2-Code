...
def plot_rel(s_name): 
    ...
    """For preseismic this method will work, for post seismic you will need to find more things to cancle from the other as the plate is relaxing and moving way more"""      
